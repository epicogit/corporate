...
add_action('do_meta_boxes', 'themnific_service_image_box');

function themnific_service_image_box() {
	remove_meta_box( 'postimagediv', 'service', 'side' );
	add_meta_box('postimagediv', __('Service Image', 'themnific'), 'post_thumbnail_meta_box', 'service', 'normal', 'high');
}
