        ...
        editor.addButton( 'Themnific_shortcodes_button', {
			...
			menu: [
                ...
                {text: 'Layout', menu: [
                	...
                	{text: 'Latest Blog Section', onclick: function() { editor.execCommand( 'insert_immediate', false, 'blog_latest', { title: 'Latest Blog Section' } ); } },
                	{text: 'Featured Blog Section', onclick: function() { editor.execCommand( 'insert_immediate', false, 'blog_featured', { title: 'Featured Blog Section' } ); } },
                	{text: 'Portfolio Classic', onclick: function() { editor.execCommand( 'insert_immediate', false, 'portfolio', { title: 'Portfolio Classic' } ); } },
                	{text: 'Portfolio Mosaic', onclick: function() { editor.execCommand( 'insert_immediate', false, 'portfolio_mosaic', { title: 'Portfolio Mosaic' } ); } },
                	...
                	{text: 'Home Video', onclick: function() { editor.execCommand( 'insert_immediate', false, 'home_video', { title: 'Home Video' } ); } },
                ]},
