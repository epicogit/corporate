...
{        
    ob_start();  
    get_template_part('/includes/homeblocks/services');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
...
{        
    ob_start();  
    get_template_part('/includes/homeblocks/clients');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
...
{        
    ob_start();  
    get_template_part('/includes/homeblocks/pricing_tabs3');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
...
{        
    ob_start();  
    get_template_part('/includes/homeblocks/pricing_tabs4');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
...
{        
    ob_start();  
    get_template_part('/includes/homeblocks/social-networks');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
...
{        
    ob_start();  
    get_template_part('/includes/homeblocks/mosaic_blog');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
...
{        
    ob_start();  
    get_template_part('/includes/homeblocks/mosaic_featured');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
...
{        
    ob_start();  
    get_template_part('/includes/homeblocks/folio');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
...
/*-----------------------------------------------------------------------------------*/
/* 18E. Portfolio Mosaic - [portfolio_mosaic]
/*-----------------------------------------------------------------------------------*/

add_shortcode('portfolio_mosaic', 'tmnf_shortcode_portfolio_mosaic');   
function tmnf_shortcode_portfolio_mosaic($attr, $content)
{        
    ob_start();  
    get_template_part('/includes/homeblocks/mosaic_folio');  
    $ret = ob_get_contents();  
    ob_end_clean();  
    return $ret;    
}
