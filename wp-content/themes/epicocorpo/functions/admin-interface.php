...
/*-----------------------------------------------------------------------------------*/
/* Admin Interface - themnificthemes_add_admin */
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* Reset Function - themnific_reset_options */
/*-----------------------------------------------------------------------------------*/
	...
	foreach ($options as $value) {
		...
		case "typography":
			...
			*/
			...
			if (strpos($val, 'Anton') !== false){ $font55 = 'selected="selected"'; }
			...
			$output .= '<option value="&quot;Anton&quot;, sans-serif" '. $font55 .'>Anton***</option>';
			$output .= '</select>';
...
/*-----------------------------------------------------------------------------------*/
/* Uploader - themnificthemes_uploader_function */
/*-----------------------------------------------------------------------------------*/
